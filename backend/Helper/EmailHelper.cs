...
namespace backend.Helper
{
    public class EmailHelper
    {
        ...
        public string RejectEventEmail(string email, string fullName, string eventName)
        {
            return $@"
                    <!DOCTYPE html>
                    <html>
                                ...
                                <td align=""center"" bgcolor=""#e9ecef"">
                                    <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"" style=""max-width: 600px;"">
                                        <tr>
                                            <td align='left' bgcolor='#ffffff' style='padding: 24px; font-size: 16px; line-height: 24px;'>
                                                <p style='margin: 0;'>Dear {fullName},<br /> <br/>
                                                    Sự kiện <strong>{eventName}</strong> của bạn bị từ chối.
                                                    <br/><br/>
                                                    Mọi thắc mắc xin liên hệ fpttickethub@gmail.com <br/> <br/>
                                                    Chân thành cảm ơn!
                                                </p>
                                            </td>
                                        </tr>
