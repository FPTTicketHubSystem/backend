...
namespace backend.Helper
{
    public class EmailHelper
    {
        ...
        public string RegisterMail(string fullname, string? email)
        {
            return $@"
                    <!DOCTYPE html>
                    <html>
...
<body style=""background-color: #e9ecef;"">
    ...
    <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">
                    ...
                    <tr>
                        <td align='left' bgcolor='#ffffff' style='padding: 24px; font-size: 16px; line-height: 24px;'>
                            <p style='margin: 0;'>Xin chào {fullname},<br /><br />
                                ...
                                <br/><br/>
                                Vui lòng sử dụng mã đánh giá sau để gửi đánh giá của bạn: <strong>{eventRatingId}</strong>
                            </p>
                        </td>
                    </tr>
                    <tr>
        ...
        public string TicketEmail(string fullName, int ticketId, string ticketType, int quantity, int orderId, decimal paymentAmount, string eventName, DateTime eventStartTime, string eventLocation, string eventAddress)
        {
            string eventLocationEncoded = HttpUtility.UrlEncode(eventLocation);
            string eventAddressEncoded = HttpUtility.UrlEncode(eventAddress);
            return $@"
                                    ...
                                    <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"" style=""max-width: 600px;"">
                                        ...
                                        <td align=""left"" bgcolor=""#ffffff"" style=""padding: 24px; font-size: 16px; line-height: 24px;"">
                                            <p style=""margin: 0;"">Thông tin vé: <br /> <br />
                                                <strong>Mã order: </strong> {paymentAmount}<br/>
                                                <strong>Tổng thanh toán: </strong> {orderId}<br/><br/>
